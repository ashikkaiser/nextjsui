								...
								<div className="ltn__product-tab-content-inner ltn__product-grid-view">
									...
									<div className="col-lg-4 col-sm-6 col-12">
										...
										<div className="product-info">
											...
											<h2 className="product-title go-top"><Link href="/product-details">New Apartment Nice View</Link></h2>
											<div className="product-img-location">
											<ul>
												<li className="go-top">
												<Link href="/contact"><i className="flaticon-pin" /> Belmont Gardens, Chicago</Link>
												</li>
											</ul>
											</div>
											...
											<ul>
												...
												<Link href="/product-details" title="Product Details">
									...
									<div className="col-lg-4 col-sm-6 col-12">
										<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
										<div className="product-img">
											<Link href="/product-details"><img src={publicUrl+"assets/img/product-3/5.jpg"} alt="#" /></Link>
											<div className="real-estate-agent">
											<div className="agent-img">
												<Link href="/team-details"><img src={publicUrl+"assets/img/blog/author.jpg"} alt="#" /></Link>
											</div>
									...
									<div className="col-lg-4 col-sm-6 col-12">
										<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
										<div className="product-img">
											<Link href="/product-details"><img src={publicUrl+"assets/img/product-3/6.jpg"} alt="#" /></Link>
											<div className="real-estate-agent">
											<div className="agent-img">
												<Link href="/team-details"><img src={publicUrl+"assets/img/blog/author.jpg"} alt="#" /></Link>
											</div>
									...
									<div className="col-lg-12">
										...
										<div className="product-info-bottom">
											...
											<div className="agent-brief go-top">
												<h6><Link href="/team-details">William Seklo</Link></h6>
						...
						<div className="ltn__quick-view-modal-inner">
							...
							<div className="row">
								...
								<div className="modal-product-info go-top">
									...
									<Link href="/wishlist" className="theme-btn-1 btn btn-effect-1">View Wishlist</Link>
									</div>
								</div>
								{/* additional-info */}
							...
							<div className="row">
								...
								<div className="modal-product-info">
									...
									<ul>
										...
										<span className="go-top">
											<Link href="/blog">Parts</Link>
											<Link href="/blog">Car</Link>
											<Link href="/blog">Seat</Link>
											<Link href="/blog">Cover</Link>
										</span>
										</li>
									</ul>
									</div>
						...
						<div className="ltn__quick-view-modal-inner">
							...
							<div className="row">
								...
								<div className="modal-product-info go-top">
									...
									<Link href="/checkout" className="theme-btn-2 btn btn-effect-2">Checkout</Link>
									</div>
								</div>
								{/* additional-info */}
								<div className="additional-info d-none">
