					...
					<div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
						...
						<div className="col-xl-6 col-sm-6 col-12 go-top">
							...
							<div className="product-img">
								<Link href="/shop"><img src={publicUrl+"assets/img/product-3/1.jpg"} alt="#" /></Link>
								<div className="real-estate-agent">
								<div className="agent-img">
									<Link href="/team-details"><img src={publicUrl+"assets/img/blog/author.jpg"} alt="#" /></Link>
								</div>
								</div>
							</div>
							<div className="product-info">
								...
								<h2 className="product-title"><Link href="/shop">New Apartment Nice View</Link></h2>
								<div className="product-img-location">
								<ul>
									<li>
									<Link href="/shop"><i className="flaticon-pin" /> Belmont Gardens, Chicago</Link>
									</li>
								</ul>
								</div>
						...
						<div className="col-xl-6 col-sm-6 col-12 go-top">
							<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
							<div className="product-img">
								<Link href="/shop"><img src={publicUrl+"assets/img/product-3/2.jpg"} alt="#" /></Link>
								<div className="real-estate-agent">
								<div className="agent-img">
									<Link href="/team-details"><img src={publicUrl+"assets/img/blog/author.jpg"} alt="#" /></Link>
								</div>
					...
					<aside className="sidebar ltn__shop-sidebar ltn__right-sidebar---">
						...
						<ul>
							...
							<div className="top-rated-product-item clearfix">
								...
								<Link href="/product-details"><img src={publicUrl+"assets/img/product/1.png"} alt="#" /></Link>
								</div>
								...
								<h6><Link href="/shop">Luxury House In Greenville </Link></h6>
								<div className="product-price">
									<span>$30,000.00</span>
									<del>$35,000.00</del>
								</div>
							...
							<div className="top-rated-product-item clearfix">
								<div className="top-rated-product-img">
								<Link href="/product-details"><img src={publicUrl+"assets/img/product/2.png"} alt="#" /></Link>
								</div>
								<div className="top-rated-product-info">
								<div className="product-ratting">
									<ul>
								...
								<h6><Link href="/shop">Apartment with Subunits</Link></h6>
								<div className="product-price">
									<span>$30,000.00</span>
									<del>$35,000.00</del>
								</div>
							...
							<div className="top-rated-product-item clearfix">
								<div className="top-rated-product-img">
								<Link href="/product-details"><img src={publicUrl+"assets/img/product/3.png"} alt="#" /></Link>
								</div>
								<div className="top-rated-product-info">
								<div className="product-ratting">
									<ul>
								...
								<h6><Link href="/shop">3 Rooms Manhattan</Link></h6>
								<div className="product-price">
									<span>$30,000.00</span>
									<del>$35,000.00</del>
								</div>
						...
						<ul className="go-top">
							<li><Link href="/blog-grid">Apartments <span>(26)</span></Link></li>
							<li><Link href="/blog-grid">Picture Stodio <span>(30)</span></Link></li>
							<li><Link href="/blog-grid">Office  <span>(71)</span></Link></li>
							<li><Link href="/blog-grid">Luxary Vilas <span>(56)</span></Link></li>
							<li><Link href="/blog-grid">Duplex House <span>(60)</span></Link></li>
						</ul>
						</div>
						...
						<div className="row ltn__popular-product-widget-active slick-arrow-1">
							...
							<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
								...
								<Link href="/shop"><img src={publicUrl+"assets/img/product-3/6.jpg"} alt="#" /></Link>
								<div className="real-estate-agent">
									<div className="agent-img">
									<Link href="/team-details"><img src={publicUrl+"assets/img/blog/author.jpg"} alt="#" /></Link>
									</div>
						...
						<ul>
							...
							<div className="popular-post-widget-item clearfix">
								...
								<Link href="/blog-details"><img src={publicUrl+"assets/img/team/5.jpg"} alt="#" /></Link>
								</div>
							...
							<div className="popular-post-widget-item clearfix">
								<div className="popular-post-widget-img">
								<Link href="/blog-details"><img src={publicUrl+"assets/img/team/6.jpg"} alt="#" /></Link>
								</div>
								<div className="popular-post-widget-brief">
								<h6><Link href="/blog-details">Lorem ipsum dolor sit
									cing elit, sed do.</Link></h6>
							...
							<div className="popular-post-widget-item clearfix">
								<div className="popular-post-widget-img">
								<Link href="/blog-details"><img src={publicUrl+"assets/img/team/7.jpg"} alt="#" /></Link>
								</div>
								<div className="popular-post-widget-brief">
								<h6><Link href="/blog-details">Lorem ipsum dolor sit
									cing elit, sed do.</Link></h6>
							...
							<div className="popular-post-widget-item clearfix">
								<div className="popular-post-widget-img">
								<Link href="/blog-details"><img src={publicUrl+"assets/img/team/8.jpg"} alt="#" /></Link>
								</div>
								<div className="popular-post-widget-brief">
								<h6><Link href="/blog-details">Lorem ipsum dolor sit
									cing elit, sed do.</Link></h6>
						...
						<ul>
							<li><Link href="/blog-grid">Popular</Link></li>
							<li><Link href="/blog-grid">desgin</Link></li>
							<li><Link href="/blog-grid">ux</Link></li>
							<li><Link href="/blog-grid">usability</Link></li>
							<li><Link href="/blog-grid">develop</Link></li>
							<li><Link href="/blog-grid">icon</Link></li>
							<li><Link href="/blog-grid">Car</Link></li>
							<li><Link href="/blog-grid">Service</Link></li>
							<li><Link href="/blog-grid">Repairs</Link></li>
							<li><Link href="/blog-grid">Auto Parts</Link></li>
							<li><Link href="/blog-grid">Oil</Link></li>
							<li><Link href="/blog-grid">Dealer</Link></li>
							<li><Link href="/blog-grid">Oil Change</Link></li>
							<li><Link href="/blog-grid">Body Color</Link></li>
						</ul>
						</div>
						{/* Banner Widget */}
						<div className="widget ltn__banner-widget d-none go-top">
						<Link href="/shop"><img src={publicUrl+"assets/img/banner/2.jpg"} alt="#" /></Link>
						</div>
					</aside>
					</div>
				</div>
