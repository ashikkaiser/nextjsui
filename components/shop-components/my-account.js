						...
						<div className="ltn__myaccount-tab-content-inner">
						  ...
						  <div className="row">
							<div className="col-md-6 col-12 learts-mb-30">
							  <h4>Billing Address <small><Link href="#">edit</Link></small></h4>
							  <address>
							...
							<div className="col-md-6 col-12 learts-mb-30">
							  <h4>Shipping Address <small><Link href="#">edit</Link></small></h4>
							  <address>
								<p><strong>Alex Tuntuni</strong></p>
								<p>1355 Market St, Suite 900 <br />
								  San Francisco, CA 94103</p>
						  ...
						  <div className="ltn__my-properties-table table-responsive">
							<table className="table">
							  ...
							  <tbody>
								<tr>
								  ...
								  <td>
									<div className="ltn__my-properties-info">
									  <h6 className="mb-10 go-top"><Link href="/product-details">New Apartment Nice View</Link></h6>
								...
								<tr>
								  <td className="ltn__my-properties-img go-top">
									<Link href="/product-details"><img src={publicUrl+"assets/img/product-3/7.jpg"} alt="#" /></Link>
								  </td>
								  <td>
									<div className="ltn__my-properties-info">
									  <h6 className="mb-10 go-top"><Link href="/product-details">New Apartment Nice View</Link></h6>
